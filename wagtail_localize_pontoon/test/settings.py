...
ROOT_URLCONF = "wagtail_localize_pontoon.test.urls"
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///test_wagtaillocalizepontoon.db"),
}
